...
import com.devbu03.base.service.product.ProductMapper;
import com.devbu03.base.service.product.ProductService;
import com.devbu03.base.service.productTemp.ProductTempService;
...
public class OrderServiceImpl implements OrderService {
  ...
  private final ProductTempService productTempService;
...
//          orderQuery.getId());
//      for (OrderDetailDTO orderDetails : orderDetailsQuery) {
//        ProductTempEntity productQuery = productTempService.findByIdTemp(
//            orderDetails.getProductId(), orderQuery.getCreatedAt());
//        ProductDTO productDTO = productMapper.getProductDTOFromProductTempEntity(productQuery);
//        orderDetails.setProduct(productDTO);
//        orderDetailResult.add(orderDetails);
//      }
//      OrderDTO result = new OrderDTO();
//      result.setId(orderQuery.getId());
